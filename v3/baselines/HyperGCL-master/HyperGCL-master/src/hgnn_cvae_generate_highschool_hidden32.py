...
import hgnn_cvae_pretrain_new_highschool
...
#     for line in lines:
#         edge_list.append((lines))

# num_vertices = len(list(set(sum(edge_list,[]))))
with open('contact-high-school/hyperedges-contact-high-school.txt', 'r') as file:
...
cvae_augmented_featuers, cvae_model = hgnn_cvae_pretrain_new_highschool.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_1226_hidden32.pkl"%args.dataset)
