...
parser.add_argument('--dataset', default='highschool', help='Dataset string.')
...
cvae_model = torch.load("{}/model/{}_1226_hidden32.pkl".format(exc_path, args.dataset))
...
def get_augmented_features(concat):
    ...
    for _ in range(concat):
        ...
        augmented_features = hgnn_cvae_pretrain_new_highschool.feature_tensor_normalize(augmented_features).detach()
        if args.cuda:
