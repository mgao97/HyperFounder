...
cvae_augmented_featuers, cvae_model = hgnn_cvae_pretrain_new_cora.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
torch.save(cvae_model,"model/%s_1223.pkl"%args.dataset)
# torch.save(cvae_augmented_featuers,"model/%s_augmented_features_1223.pkl"%args.dataset)
