    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(net.state_dict(), 'model/hgnn_cocitationcora_best_model_1227_hid32.pth')
        # scheduler.step()
    print("\ntrain finished!")
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                best_val = val_acc
                best_state = deepcopy(net.state_dict())
                torch.save(net.state_dict(), 'model/hypergcn_cocitationcora_best_model_1227_hid32.pth')
        # scheduler.step()
    print("\ntrain finished!")
    print(f"best val: {best_val:.5f}")
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(model_unigin.state_dict(), 'unigin_cocitationcora_best_model_model_hid32.pth')
    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if val_acc > best_val:
                ...
                torch.save(model_unisage.state_dict(), 'unisage_cocitationcora_best_model_model_hid32.pth')
