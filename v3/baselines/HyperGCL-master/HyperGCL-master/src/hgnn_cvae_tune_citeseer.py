...
best_augmented_features, _ = hgnn_cvae_pretrain_new_citeseer.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
best_augmented_features = hgnn_cvae_pretrain_new_citeseer.feature_tensor_normalize(best_augmented_features).detach()
