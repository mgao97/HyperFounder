...
parser.add_argument('--dataset', default='coauthorcora',
                    help='Dataset string.')
...
best_augmented_features, _ = hgnn_cvae_pretrain_new_coauthorcora.get_augmented_features(args, hg, X, labels, idx_train, features_normalized, device)
best_augmented_features = hgnn_cvae_pretrain_new_coauthorcora.feature_tensor_normalize(best_augmented_features).detach()
