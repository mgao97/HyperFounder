...
from trainers.pretrain_trainer_neg_sam import PretrainTrainerNegSam
from utils.common import load_yaml, save_json, set_seed


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run hypergraph pretraining with negative sampling.")
